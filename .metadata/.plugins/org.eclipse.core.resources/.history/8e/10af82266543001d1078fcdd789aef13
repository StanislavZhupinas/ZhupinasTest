...
import testng.PageObjects.Test6Page;
...
public class NewTest {
	...
	public void Test5() {
		...
		//Assert that the button is now disabled
		page2.buttonStateValidation(page.getActiveButton(), false);
	}
	...
	public void Test6() {
		...
		Test6Page page = PageFactory.initElements(driver, Test6Page.class);
		...
		//Use the method to find the value of the cell at coordinates 2, 2 (staring at 0 in the top left corner)
		//Assert that the value of the cell is "Ventosanzap"
		page.returnSellValue(2, 2, "Ventosanzap");
	}
}
